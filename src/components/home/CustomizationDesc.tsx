    ...
    <div className="bg-[#f2f8f6]">
      <div className="flex flex-col h-auto min-h-[50vh] py-4 mx-2 gap-4 sm:gap-6 sm:mx-4 md:gap-8 md:mx-5 md:min-h-[60vh] lg:flex-row lg:justify-between lg:h-[60vh] lg:mx-16 lg:gap-6 xl:h-[65vh] xl:mx-16 2xl:h-[90vh] 3xl:h-[70vh] 3xl:mx-36">
        ...
        <div className="flex flex-col gap-3 sm:gap-4 md:gap-6 lg:mt-20 lg:gap-6">
          <h1 className="uppercase text-xl font-semibold leading-tight sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl 3xl:text-7xl">
          ...
          <div>
            <Link href="/enquiry">
              <button className="bg-[var(--color-green)] hover:shadow-2xl hover:scale-105 transition-all text-white text-base sm:text-lg md:text-xl md:p-2.5 lg:text-3xl lg:p-3 rounded-xl cursor-pointer text-center p-2">
                Enquire Now
              </button>
            </Link>
          </div>
        ...
        {/* Feature Cards */}
        <div className="flex flex-row gap-3 sm:gap-4 md:gap-8 lg:flex-col lg:gap-6 lg:my-10">
