...
interface ServiceDetailClientProps {
  ...
  interestingServices: ExtendedService[];
  slug: string;
}
...
export default function ServiceDetailClient({
  ...
  useEffect(() => {
    setActiveImage(service.displayImage || "");
  }, [service.displayImage]);
  ...
  const shareViaEmail = () => {
    const subject = encodeURIComponent(
      `Check out this service: ${service.displayTitle}`
    );
    ...
    try {
      ...
      const emailResponse = await fetch("/api/send-interest", {
        ...
        body: JSON.stringify({
          ...
          serviceTitle: service.displayTitle,
  ...
  const structuredData = {
    ...
    image: [service.displayImage, ...(service.additionalImages || [])].filter(
      Boolean
    ),
  ...
  function watch(path: string): string | null | undefined {
    ...
    if (matches && matches[1]) {
      ...
      return service.customSections && service.customSections[sectionIndex]?.content;
    }
    return undefined;
  }
  ...
  return (
    <>
      <Head>
        <title>{service.displayTitle} | Your Service Provider</title>
        <meta
          name="description"
          content={
            service.description || `${service.displayTitle} - ${service.group || "Service"}`
          }
        />
        <meta
          name="keywords"
          content={
            service.seoKeywords || `${service.displayTitle}, ${service.group}, service online`
          }
        />
        <meta property="og:title" content={service.displayTitle} />
        <meta
          property="og:description"
          content={service.description || service.displayTitle}
        />
        <meta property="og:image" content={service.displayImage || "/default-image.jpg"} />
        <meta property="og:type" content="service" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={service.displayTitle} />
        <meta
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <section className="p-6 lg:p-8" aria-label="Service Images">
                <motion.div
                ...
                >
                  <Image
                    ...
                    alt={`${service.displayTitle} - Main service image`}
                    fill
                ...
                {service.additionalImages &&
                  service.additionalImages.length > 0 && (
                    <div className="mt-6 flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                      {[service.displayImage, ...service.additionalImages].map(
                        (img, index) => (
                          <motion.button
                            key={index}
                            ...
                            aria-label={`View image ${index + 1} of ${service.displayTitle}`}
                          >
                            <Image
                              src={img}
                              alt={`${service.displayTitle} thumbnail ${index + 1}`}
                              fill
                              sizes="80px"
              ...
              >
                <div>
                  ...
                  {(service.description || service.applications) && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    {service.video && (
                      <motion.a
                        ...
                        aria-label="Watch service video"
                      >
          ...
          {service.customSections && service.customSections.length > 0 && (
            <motion.section
              ...
              className="mt-12"
              aria-label="Detailed Service Information"
            >
            ...
            >
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  Explore our other premium services that complement your
                  interests
                </p>
              </div>
                  ...
                  >
                    <Link
                      href={`/services/${createSlug(
                        interestingService.name
                      )}?id=${interestingService._id}`}
                      className="block"
                    >
                      <div
                      ...
                      >
                        <Image
                          src={
                            interestingService.displayImage ||
                            "/no-image-placeholder.png"
                          }
                          alt={`${interestingService.displayTitle} - Service image`}
                          fill
                      ...
                      <div className="p-6">
                        <div className="flex items-center gap-2 mb-2">
                          <span className="text-xs font-medium text-[var(--color-green)] bg-green-50 px-2 py-1 rounded-full">
                            {interestingService.group || "Service"}
                          </span>
                        </div>
                ...
                {[
                  {
                    ...
                    description:
                      "All our services meet the highest quality standards with professional execution.",
                  },
                  {
                    icon: "🚀",
                    title: "Fast Response",
                    description:
                      "Quick and reliable support to address your needs promptly.",
                  },
                  {
                    icon: "🛡️",
                    title: "Customer Satisfaction",
                    description:
                      "Comprehensive support and satisfaction guarantee with every service.",
                  },
                ].map((feature, idx) => (
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              "@context": "https://schema.org",
              "@type": "FAQPage",
              mainEntity: service.customSections.map((section) => ({
                "@type": "Question",
                name: section.title,
                acceptedAnswer: {
                  "@type": "Answer",
